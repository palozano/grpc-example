// This is the generated code from the proto file by tonic.
...
mod proto {
    // includes the package in the proto buf file
    tonic::include_proto!("calculator");

    // this if for reflection
...
// This is used for implementing the Calculator service RPC methods generated by tonic.
...
impl Calculator for CalculatorService {
    async fn add(
        ...
        let response = proto::CalculationResponse {
            // we get compile time type checking here
